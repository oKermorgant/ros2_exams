...
\begin{bashcodelarge}
 ros2 launch ecn_2022 simulation_launch.py
\end{bashcodelarge}
...
\begin{bashcodelarge}
 ros2 launch ecn_2022 slider_launch.py
\end{bashcodelarge}

\section{Tips}

Compile the code once using \okt{colbuild --packages-select ecn_2022}. Then, use \okt{gqt} in the package folder to configure QtCreator. Do not forget to use it with ROS 2 setup.\\
